...
<Carousel className="dots-closer text-center" navigation={false} grabCursor slidesPerView={1}>
  {[1, 2, 3].map((item) => (
    <p key={item}>
      Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Nullam id dolor id nibh ultricies vehicula ut id elit. Enterprise-grade database and cloud solutions empowering global business infrastructure.Cras mattis consectetur purus sit amet fermentum.
    </p>
  ))}
</Carousel>
`;
