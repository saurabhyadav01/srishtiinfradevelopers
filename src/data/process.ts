...
export const processList1 = [
  {
    ...
    className: 'me-lg-6',
    title: 'Collect Ideas',
    subtitle: 'Get assistance anytime with our dedicated support team, ready to help you resolve issues and answer questions around the clock.'
  },
  {
    no: '2',
    title: 'Data Analysis',
...
export const processList3 = [
  {
    ...
    className: 'me-lg-6',
    title: 'Collect Ideas',
    subtitle: 'Get assistance anytime with our dedicated support team, ready to help you resolve issues and answer questions around the clock. Praesent commodo cursus.'
  },
  {
    no: '2',
    title: 'Data Analysis',
...
export const processList9 = [
  {
    ...
    color: 'purple',
    title: 'Collect Ideas',
    subtitle: 'Get assistance anytime with our dedicated support team, ready to help you resolve issues and answer questions around the clock. Fusce dapibus, tellus ac cursus commodo.'
  },
  {
    no: '02',
    color: 'green',
