...
export const serviceList1 = [
  {
    id: 1,
    link: '/partner/oracle',
    icon: '/img/oracle-partner-logo.png',
    title: 'ORACLE',
    linkText: 'Learn More',
    linkType: LinkType.yellow,
    description: `Enterprise-grade database and cloud solutions empowering global business infrastructure.`
  },
  {
    id: 2,
    link: '/partner/microsoft',
    icon: '/img/microsoft-partner-logo.png',
    title: 'MICROSOFT',
    linkText: 'Learn More',
    linkType: LinkType.red,
    description: `Cloud, AI, and productivity tools built to scale enterprise performance and innovation.`
  },
  {
    id: 3,
    link: '/partner',
    icon: '/img/google-cloud.png',
    linkType: LinkType.green,
    title: 'GOOGLE CLOUD',
    linkText: 'Learn More',
    description: `AI-powered cloud services designed for data analytics, scalability, and security .`
  },
  {
    id: 4,
    link: '/partner/aws',
    ...
    linkText: 'Learn More',
    description: `Leading cloud infrastructure offering reliable, scalable, and low-cost computing services.`
  }
];
