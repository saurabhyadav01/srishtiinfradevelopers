  ...
  return (
    <section id="pricing">
      <div
        ...
        style={{ backgroundImage: 'url(/img/hero/04.jpg)' }}
      >
            ...
            <div className="col-xl-9 mx-auto">
              <div className="card border-0 bg-white-900">
                <div className="card-body py-lg-13 px-lg-16">
                  <h2 className="display-5 mb-3 text-center">Contact Us</h2>
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-4">
                          <input
                            ...
                            className="form-control bg-white-700 border-0"
                          />
                          <label htmlFor="form_name">Job Title *</label>
                          <div className="valid-feedback">Looks good!</div>
                          <div className="invalid-feedback">Please enter your name.</div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-4">
                          <input
                            ...
                            className="form-control bg-white-700 border-0"
                          />
                          <label htmlFor="form_email">Company Email *</label>
                          <div className="valid-feedback">Looks good!</div>
                          <div className="invalid-feedback">Please provide a valid email address.</div>
                        </div>
                        ...
                        <div className="form-floating mb-4">
                          <input
                            ...
                            className="form-control bg-white-700 border-0"
                          />
                          <label htmlFor="form_name">Company Website *</label>
                          <div className="valid-feedback">Looks good!</div>
                          <div className="invalid-feedback">Please enter your name.</div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-4">
                          <input
                            ...
                            className="form-control bg-white-700 border-0"
                          />
                          <label htmlFor="form_email">Country *</label>
                          <div className="valid-feedback">Looks good!</div>
                          <div className="invalid-feedback">Please provide a valid email address.</div>
                        </div>
                      </div>
