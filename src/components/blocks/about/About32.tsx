    ...
    <Fragment>
      <div className="row gy-10 gy-sm-13 gx-md-8 gx-xl-12 align-items-center mb-10 mb-md-12">
        ...
        <div className="col-lg-6">
          ...
          <p className="mb-6">
            Enterprise-grade database and cloud solutions empowering global business infrastructure.Cras justo odio,
            dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna, vel scelerisque nisl consectetur
            et. Enterprise-grade database and cloud solutions empowering global business infrastructure.Aenean lacinia
            bibendum nulla sed.
          </p>
