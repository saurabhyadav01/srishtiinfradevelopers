  ...
  return (
    <div className="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
      ...
      <div className="col-lg-5 mt-lg-n10 text-center text-lg-start">
        ...
        SaaS vendors which likely will impact business processes and integration with core systems of record.

Simply, the core Test Center of Excellence (CoE) functions needed to test integration points, database services, business processes struggle to keep pace managing: Test & Service, Tools & Subject Matter Expertise (SME).</p>
