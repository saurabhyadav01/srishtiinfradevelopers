    ...
    <div className="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
      ...
      >
        ...
        <figure className="rounded">
          <img src="/img/hero/icons/SAFE-SWITCH.jpg"  alt="hero" />
        </figure>
      </div>
      ...
      <div className="col-lg-5 mt-lg-n10 text-center text-lg-start">
        ...
        Many businesses are faced with the challenge to drive digital transformation and create strategies that enable innovation. To stay competitive, organizations must adopt cloud-based deployments that allow rapid development releases, reduce complexity, enforce streamlined standards, move away from perpetualized vendor lock-in, and in most cases, reduce overheads..
       </p>
        <p className="lead fs-14 lh-sm mb-7 px-md-10 px-lg-0" style={slideInDownAnimate('900ms')}>
