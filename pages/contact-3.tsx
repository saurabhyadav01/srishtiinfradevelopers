                ...
                <div className="row gy-10 gx-lg-8 gx-xl-12">
                  ...
                  <div className="col-lg-4">
                    <div className="d-flex flex-row">
                      ...
                      <div>
                        <h5 className="mb-1">Arglin Tech Private Limited</h5>
                        <address>USA Office: New Hampshire, United States<br />India Office: New Delhi, India</address>
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-row">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          <a href="mailto:info@arglin.com" className="link-body">
                            info@arglin.com
                          </a>
                        </p>
                      </div>
