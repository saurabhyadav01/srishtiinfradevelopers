                      ...
                      <div className="p-10 p-md-11 p-lg-14">
                        <div className="d-flex flex-row">
                          ...
                          <div className="align-self-start justify-content-start">
                            ...
                            <address>
                              USA Office: <br className="d-none d-md-block" />
                              New Hampshire, United States
                            </address>
                            <address className="mt-2">
                              India Office: <br className="d-none d-md-block" />
                              New Delhi, India
                            </address>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row">
                          ...
                          <div>
                            ...
                            <p>
                              USA: +1-603-9300-375 <br />
                              India: +91 96506 23339
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row">
                          ...
                          <div>
                            ...
                            <p className="mb-0">
                              <a href="mailto:info@thissrishtiinfradevelopers.com" className="link-body">
                                info@thissrishtiinfradevelopers.com
                              </a>
                            </p>
                          </div>
                        </div>
