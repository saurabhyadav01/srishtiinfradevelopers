          ...
          <div className="container py-14 py-md-16">
            ...
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
              ...
              <div className="col-lg-5">
                ...
                <p className="mb-6">
  We are a team of passionate innovators, dedicated to crafting digital solutions that drive business growth and elevate user experiences. From strategy to execution, we partner with our clients to turn ideas into impactful outcomes.
</p>
