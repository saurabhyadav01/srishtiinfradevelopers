          ...
          <div className="container pt-10 pb-17 pt-md-14 text-center">
            <div className="row">
              <div className="col-lg-8 mx-auto mb-5">
                ...
                <h3 className="display-1 mb-6">CAREERS IN CLOUD ,ERP AND DATABASE TECHNOLOGY.</h3>
          ...
          <div className="container pb-15 pb-md-17">
            ...
            <div className="row gy-10 gy-sm-13 gx-md-8 gx-xl-12 align-items-center mt-12">
              ...
              <div className="col-lg-6">
                ...
                <p className="mb-6">
                We don’t just deliver services — we solve problems with purpose and precision. Our difference lies in how we combine deep technical expertise, real-world understanding, and a relentless focus on customer outcomes.
We bring smart, scalable solutions that simplify complexity, automate the manual, and streamline the everyday — so our customers can focus on what matters most.
                </p>
